...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- title -->
        <title>UpSkill`s -  Developer</title>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="90" class="side-nav before-after">
        ...
        <header class="left-logo">
            <!-- start logo -->
            <a class="navbar-brand" href="#."><img src="images\logo-blue-white.png" alt="logo"></a>
            <!-- end logo -->
            ...
            <div class="sidebar_menu">
                <nav class="pushmenu pushmenu-right">
                    ...
                    <ul class="push_nav centered">
                        ...
                        <li class="clearfix">
                            <a href="#features" class="scroll"> <span>02.</span>Feature</a>
        ...
        <section id="features">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-10 col-sm-12 text-center center-col">
                        <div class="area-heading text-center margin-70px-bottom">
                            <div class="text-medium text-red margin-10px-bottom">One Page Creative Design</div>
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="background:url(images/about-slide-one.jpeg)"></div>
                            <div class="swiper-slide" style="background:url(images/about-slide-two.jpeg)"></div>
                            <div class="swiper-slide" style="background:url(images/about-slide-four.jpeg)"></div>
                            <div class="swiper-slide" style="background:url(images/about-slide-five.jpeg)"></div>
                            <div class="swiper-slide" style="background:url(images/about-slide-three.jpeg)"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <hr class="margin-50px-top margin-80px-bottom">
                    <div class="col-lg-9 col-md-10 col-sm-12 text-center center-col">
                        <div class="area-heading text-center margin-50px-bottom">
                            <h5 class="area-title text-capitalize alt-font text-blue margin-20px-bottom font-weight-300 sm-width-100 xs-width-100">
                                What <span style="color: red;">Services</span> We Do</h5>
                        </div>
                    </div>

                    <!-- how list -->
                    <?php include './services-index.php';?>
        ...
        <section class="no-padding particles-version no-transition">
            ...
            <div id="particles-js">
                <div class="col-xs-12 text-center center-col">
                    <p class="text-white margin-20px-bottom"></p>
                    <h4 class="text-capitalize alt-font text-white margin-30px-bottom font-weight-300 sm-width-100 xs-width-100">
                        Are You Ready To Start Your Website ? </h4>
                    <a href="#." class="btn btn-rounded btn-white btn-hvr-red btn-large">Log in</a>
                </div>
            </div>
        </section>
        <!-- end parallax -->
        ...
        <!-- team about -->
        <section id="about" class="xs-text-center no-padding-bottom">
            <div class="container">
                            ...
                            <div class="c-progress text-left xs-margin-15px-left no-transition">
                                <div class="row custom-progress width-100 margin-10px-bottom">
                                    ...
                                    <div class="col-xs-10 no-padding-right">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-red" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row custom-progress width-100 margin-10px-bottom">
                                    ...
                                    <div class="col-xs-10 no-padding-right">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-blue" role="progressbar" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row custom-progress width-100 margin-10px-bottom">
                                    ...
                                    <div class="col-xs-10 no-padding-right">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-blue" role="progressbar" aria-valuenow="99" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row custom-progress width-100 margin-10px-bottom">
                                    ...
                                    <div class="col-xs-10 no-padding-right">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-red" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-box sm-margin-30px-bottom xs-margin-30px-bottom">
                            <div class="team-image">
                                <img src="images\team-one.jpeg" alt="image">
                            </div>
                            <div class="team-three-tag">
                                <div class="team-three-text display-inline float-left text-left">
                                    <h6 class="text-extra-dark-gray no-margin-bottom">Mike <span class="text-red">Kongel</span></h6>
                                    <p class="no-margin-bottom">Comapny CEO</p>
                                </div>
                                <div class="team-three-social bg-red" aria-hidden="true">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-box sm-margin-30px-bottom xs-margin-30px-bottom">
                            <div class="team-image">
                                <img src="images\team-two.jpeg" alt="image">
                            </div>
                            <div class="team-three-tag">
                                <div class="team-three-text display-inline float-left text-left">
                                    <h6 class="text-extra-dark-gray no-margin-bottom">David <span class="text-blue">Mocha</span></h6>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="team-box sm-no-margin-bottom xs-no-margin-bottom">
                            <div class="team-image">
                                <img src="images\team-three.jpeg" alt="image">
                            </div>
                            <div class="team-three-tag">
                                <div class="team-three-text display-inline float-left text-left">
                                    <h6 class="text-extra-dark-gray no-margin-bottom">Mike <span class="text-red">Kongel</span></h6>
            ...
            <div class="row">
                ...
                <div class="gallery text-center">
                    ...
                    <div class="col-md-3 items brand sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-8.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-8.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items graphic sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-3.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-3.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items web sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-6.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-6.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items web sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-5.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-5.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items graphic sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-4.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-4.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items brand sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-2.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-2.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 items graphic sm-width-100">
                        <div class="item-img">
                            <img src="images\Portfolio-9.jpeg" alt="image">
                            <div class="item-img-overlay valign">
                                <div class="overlay-info width-100">
                                    <h6 class="margin-5px-bottom">Recent Work</h6>
                                    <p>See Our Amazing Work</p>
                                </div>
                                <a href="images\Portfolio-9.jpeg" data-fancybox="images">
                                    <i class="fa fa-camera portfolio-icon"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="counter-item text-center sm-margin-30px-bottom">
                            <div class="counter-icon bg-blue margin-20px-bottom">
                                <i class="fa fa-check" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-extra-dark-gray font-weight-100 no-margin-bottom">2540</h3>
                            <p class="no-margin-bottom font-weight-400 text-medium-gray">Projects Completed</p>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="counter-item text-center sm-margin-30px-bottom">
                            <div class="counter-icon bg-red margin-20px-bottom">
                                <i class="fa fa-coffee" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-extra-dark-gray font-weight-100 no-margin-bottom">7325</h3>
                            <p class="no-margin-bottom font-weight-400 text-medium-gray">Coffees Consumed</p>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="counter-item text-center sm-margin-30px-bottom">
                            <div class="counter-icon bg-new-yellow margin-20px-bottom">
                                <i class="fa fa-heart" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-extra-dark-gray font-weight-100 no-margin-bottom">1924</h3>
                            <p class="no-margin-bottom font-weight-400 text-medium-gray">Happy Customers</p>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="counter-item text-center sm-margin-30px-bottom">
                            <div class="counter-icon bg-lg-blue margin-20px-bottom">
                                <i class="fa fa-cog" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-extra-dark-gray font-weight-100 no-margin-bottom">4275</h3>
                            <p class="no-margin-bottom font-weight-400 text-medium-gray">Lines Of Code</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="owl-theme owl-carousel owl-testimonial-two">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="testimonial-client-img">
                                    <img src="images\testimonial-two-client2.jpeg" alt="image">
                                </div>
                    ...
                    <div class="testimonial-two-block item">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="testimonial-client-img">
                                    <img src="images\testimonial-two-client1.jpeg" alt="image">
                                </div>
                                <div class="testimonial-client-name">
                    ...
                    <div class="testimonial-two-block item">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="testimonial-client-img">
                                    <img src="images\testimonial-two-client3.jpeg" alt="image">
                                </div>
                                <div class="testimonial-client-name">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-10 col-sm-12 text-center center-col">
                        ...
                        <h4 class="area-title alt-font text-dark-gray margin-20px-bottom font-weight-300 sm-width-100 xs-width-100">
                            We <span class="text-red font-weight-500">love</span> what we do<br>&amp; we do it with <span class="text-red font-weight-500">passion!</span></h4>
                        <a data-fancybox="" href="https://vimeo.com/191947042" class="btn btn-rounded btn-blue btn-extra-large btn-hvr-red margin-20px-top"><i class="fa fa-play video-social" aria-hidden="true"></i>Watch Now</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- blog -->
        <section id="blog" class="blog-two bg-very-light-gray">
            ...
            <div class="container">
                ...
                <div class="row no-margin">
                    <div class="blog-two-block">
                        <div class="col-md-8 col-sm-6 no-padding">
                            <div class="blog-two-img"><img src="images\blog-two-img1.jpeg" alt="image">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 no-padding">
                            <img class="xs-display-none" src="images\blog-two-img2.jpeg" alt="image">
                            <div class="blog-two-overlay hvr-bg-blue center-block text-extra-dark-gray text-center">
                                <h6 class="text-extra-large font-weight-600 no-margin-bottom">Amazing Creativity</h6>
                                <div class="text-small margin-15px-bottom">09 Fab, 2018</div>
                                <p class="text-center padding-10px-lr">Maecenas ut lectus a ipsum gravida ornare. Cras scelerisque in mauris id pretium.</p>
                                <a href="#." class="btn btn-blue btn-rounded btn-medium margin-20px-top">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="blog-two-block">
                        <div class="col-md-4 col-sm-6 small-push-6 no-padding">
                            <img class="xs-display-none" src="images\blog-two-img2.jpeg" alt="image">
                            <div class="blog-two-overlay hvr-bg-red center-block text-extra-dark-gray text-center">
                                <h6 class="text-extra-large no-margin-bottom">Awesome Websites</h6>
                                <div class="text-small margin-15px-bottom">09 Fab, 2018</div>
                                <p class="text-center padding-10px-lr">Maecenas ut lectus a ipsum gravida ornare. Cras scelerisque in mauris id pretium.</p>
                                <a href="#." class="btn btn-red btn-rounded btn-medium margin-20px-top">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-6 small-pull-6 no-padding">
                            <div class="blog-two-img"> <img src="images\blog-two-img3.jpeg" alt="image">
                            </div></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-form">
                            ...
                            <div class="address bg-light-gray padding-20px-all xs-margin-50px-bottom">
                                <div class="address-item">
                                    <div class="row">
                                        <div class="col-xs-1 no-padding text-center margin-20px-bottom"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                                        <div class="col-xs-11">
                                            <div class="text-small text-blue margin-20px-bottom">Address:<span class="text-dark-gray display-block">Come visit us: 123 New Street, Our City , Australia.</span>
                                            </div>
                                        </div>
                                        <div class="col-xs-1 no-padding text-center"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
                                        <div class="col-xs-5">
                                            <div class="text-small text-blue">Email:<span class="text-dark-gray display-block">email@website.com</span>
                                            </div>
                                        </div>
                                        <div class="col-xs-1 no-padding text-center"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                        <div class="col-xs-5">
                    ...
                    <div class="gallery-demo width-100">
                        <a href="index.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index2.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index2.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index-multi.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index20.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index3.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index3.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index20.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index21.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index6.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index6.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index16.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index16.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index18.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index18.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index17.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index17.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index22.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index24.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index23.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index23.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index21.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index22.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index7.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index7.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index8.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index8.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index9.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index9.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index10.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index10.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index11.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index11.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index14.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index14.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index13.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index13.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index12.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index12.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index15.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index15.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index4.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index4.jpeg" alt="image">
                            </div>
                        ...
                        <a href="index5.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\index5.jpeg" alt="image">
                            </div>
                        ...
                        <a href="comingsoon.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\comingsoon.jpeg" alt="image">
                            </div>
                        ...
                        <a href="error.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\error.jpeg" alt="image">
                            </div>
                        ...
                        <a href="standalone.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\standalone.jpeg" alt="image">
                            </div>
                        ...
                        <a href="blog-left.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\blog-left.jpeg" alt="image">
                            </div>
                        ...
                        <a href="blog.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\blog-details.jpeg" alt="image">
                            </div>
                        ...
                        <a href="blog-right.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\blog-right.jpeg" alt="image">
                            </div>
                            <div class="text-large text-white margin-15px-tb font-weight-600">Blog Right</div>
                        </a>

                        <a href="shop.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\shop.jpeg" alt="image">
                            </div>
                        ...
                        <a href="shop-detail.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\shop-details.jpeg" alt="image">
                            </div>
                        ...
                        <a href="shop-cart.html" target="_blank" class="col-sm-4 demo-item onepage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\shop-cart.jpeg" alt="image">
                            </div>
                        ...
                        <a href="feature-page.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\feature.jpeg" alt="image">
                            </div>
                        ...
                        <a href="about-page.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\about.jpeg" alt="image">
                            </div>
                        ...
                        <a href="work-page.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\work.jpeg" alt="image">
                            </div>
                        ...
                        <a href="price-page.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\price.jpeg" alt="image">
                            </div>
                        ...
                        <a href="blog-element.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\blog-element.jpeg" alt="image">
                            </div>
                        ...
                        <a href="contact.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\contact.jpeg" alt="image">
                            </div>
                        ...
                        <a href="login.html" target="_blank" class="col-sm-4 demo-item multipage">
                            <div class="demo-item-image">
                                <img src="images\demo-images\login.jpeg" alt="image">
                            </div>
        ...
        <script src="revolution\js\revolution.addon.beforeafter.min.js"></script>
